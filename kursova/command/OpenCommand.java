...
public class OpenCommand {
    ...
    public OpenCommand(CommandContext context, WarehouseService warehouseService, FileService fileService) {
    ...
    public void execute(String input) {
        ...
        warehouseService.setItems(fileService.loadFromFile(fileName));
